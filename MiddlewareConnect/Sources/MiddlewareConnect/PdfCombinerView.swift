/**
@fileoverview PDF Combiner view for combining multiple PDFs
@module PDFCombiner/Views
Created: 2025-04-02
...
- PdfCombinerView
Notes:
- Main view for PDF combination functionality
- Uses state container pattern for state management
