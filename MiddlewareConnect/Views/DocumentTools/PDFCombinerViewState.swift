/**
 * @fileoverview View state container for PDF Combiner view
 * @module PDFCombinerViewState
 * 
 * Created: 2025-04-02
...
/// View state container for PDF Combiner view
final class PDFCombinerViewState: ObservableObject {
    ...
    init(pdfService: PDFService = PDFService.shared) {
